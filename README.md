...
- 🏡 作品：
  ...
  | 类别               | 项目                                                         |
  | ------------------ | ------------------------------------------------------------ |
  | 猫脸识别项目        | [基于应用开发](https://github.com/)<br>[正在维护...]() |
  | 项目    | [基于应用开发](https://github.com/)<br>[代码自动](https://github.com/hongyoudan)<br>[正在维护...]() |
  | 项目     | [正在维护...]()                                              |
  | 更多作品脱发整理中 |                                                              |

- 💬 邮箱：shaowendeng@foxmail.com

- 😄**前端** HTML、CSS、JavaScript、jQuery、Bootstrap
- 😃**后端** Python、Java、C
- 😶**设计** Photoshop、Premiere、Audition
- 😆**软件** Anaconda、Sublime Text、Visual Studio
- 😝**框架** Django、Flask、Servlet、MFC
